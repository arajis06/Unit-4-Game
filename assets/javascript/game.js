...
var startGame = function() {
    ...
    for(var i = 0; i < 4; i++) {
        ...
        var crystal = $("<div>");   //THE CRYSTAL VARIABLE IS ASSIGNED A VALUE OF <DIV> SO THAT IT CAN BE USED TO INSIDE THE CRYSTALS TO CREATE 4 NESTED ELEMENTS 
            ...
            crystal.html(crystal_RandomNum);  //SHOWS IN THE DOM THE RANDOM NUMBER IN THE CRYSTAL BOXES  --TESTING GAME ONLY-- DELETE

        $(".game-crystals").append(crystal);   //THIS WILL APPENDING THE 4 NEW CRYSTAL DIVS TO THE INDEX.HTML FILE 
    }

    $("#crystals-sum").html(sumOfCrystalsNum); //THIS WILL PASS THE TOTAL SUM OF ALL THE CRYSTALS THAT WERE CLICKED IN THE INDEX.HTML FILE
...
$(document).on("click", ".crystal", function() {    //!!!!this works bc of EVEN DELEGATION RULES)
    ...
    sumOfCrystalsNum += hiddenNums;  //THIS IS WILL ADD THE PREVIOUS UNLOCKED NUMBERS AND THE NEW UNLOCKED CRYSTAL HIDDEN NUMBER TOGETHER FOR SUM
    ...
    if(sumOfCrystalsNum > game_RandomNum) {  //IF THE SUM OF ALL CLICKED CRYSTAL NUMBERS ARE GREATER THAN THE GAME RANDOM NUMBER .....
        ...
        sumOfCrystalsNum = 0; //RESETS THE TOTAL OF HIDDEN CRYSTALS THAT WERE UNLOCKED BY THE CLICK FOR NEW GAME
